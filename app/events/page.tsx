    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
      ...
      <div className="container mx-auto px-4 pt-28 pb-16">
        <motion.div
          ...
          className="mb-10"
        >
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Upcoming Events</h1>
          <p className="text-slate-600 dark:text-slate-400 max-w-2xl">Discover and attend events that matter to you. Filter by location, date, and more to find the perfect match.</p>
        </motion.div>
          ...
          >
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex flex-wrap gap-2">
                <Button size="sm" variant="outline" className="border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900">
      ...
      >
        <div className="container mx-auto px-4 text-center text-sm text-slate-500 dark:text-slate-400">
          ...
          <p>© {new Date().getFullYear()} Events AI. All rights reserved.</p>
        </div>
      </motion.footer>
    </div>
  );
